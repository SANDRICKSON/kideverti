...
def contact():
    ...
    if form.validate_on_submit():
        ...
        new_message = Message(
            ...
            message_content=form.message.data,  # Get the content of the message
            sent_at=datetime.utcnow()  # Timestamp of when the message was sent
        )
        new_message.create()  # Save to the database
